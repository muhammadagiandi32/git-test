...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Pembayaran</span>
        </h3>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row mb-5">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" id="NamaSupplierMitra" class="form-control"
                    ...
                    <div class="col-4 mt-5">
                        ...
                        <div class="text-center">
                            <img src="https://wso2.com/files/wp-content/files/2017/10/How-API-path-is-constructed-and-translated-to-backend.png"
...
<script type="text/javascript">
    ...
    var table = $('.data-table').DataTable({
        ...
        scrollY: 500,
        scrollX: true,
        ajax: "{{ route('showroom.pembayaran.index') }}",
        columns: [
            {
                title:'Nama Supplier',
                data: 'Mitra'
    ...
    $('body').on('click', '.viewDetails', function (e) {
        ...
        $.ajax({
            url: `{{ url('showroom/pembayaran/${dataId}') }}`,
            type: "GET",
            dataType: 'json',
            beforeSend: function() {
                swal.fire({
