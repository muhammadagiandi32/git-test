...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">PO Showroom</span>
        </h3>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group row mb-5">
                        <div class="col-lg-3">
                            <label>Nomor PO / SPK:</label>
                            <input type="text" id="deatilNomorPO" class="form-control" placeholder="Enter PO / SPK"
                                readonly />
                        </div>
                        <div class="col-lg-3">
                            <label>PPn (%):</label>
                            <input type="text" id="deatilPPn" class="form-control" placeholder="Enter your PPn"
                                readonly />
                        </div>
                        <div class="col-lg-3">
                            <label>Menyetujui:</label>
                            <input type="text" id="deatilMenyetujui" class="form-control"
                                placeholder="Enter your Menyutujui" readonly />
                        </div>
                        <div class="col-lg-3">
                            <label>Jenis PPn:</label>
                            <input type="text" id="deatilJenisPPn" class="form-control"
                                placeholder="Enter your Jenis PPn" readonly />
                        </div>
                    </div>
                    <div class="form-group row pt-5 mb-5">
                        <div class="col-lg-3">
                            <label>Nama Supplier:</label>
                            <input type="text" id="deatilNamaSupplier" class="form-control"
                                placeholder="Enter Nama Supplier" readonly />
                            {{-- <select class="form-control selectpicker" data-size="7" data-live-search="true"
                                id="deatilNamaSupplier" required>
                                <option data-tokens="-">-</option>
                            </select> --}}
                        </div>
                        <div class="col-lg-2">
                            <label>Tanggal PO:</label>
                            <input type="text" id="deatildate" class="form-control" placeholder="Enter your Tanggal PO"
                                readonly />
                            {{-- <div id="datetimepicker1" class="input-append date">
                                <input data-format="dd/MM/yyyy hh:mm:ss" type="date"></input>
                                <span class="add-on">
                                    <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                    </i>
                                </span>
                        ...
                        <div class="col-lg-3">
                            <label>Nilai Discount:</label>
                            <input type="text" id="deatilDiscount" class="form-control"
                                placeholder="Enter your Tanggal Nilai Discount" readonly />
                        </div>
                        <div class="col-lg-2">
                            <label>Kategori:</label>
                            <input type="text" id="deatilKategori" class="form-control"
                                placeholder="Enter your Kategori" readonly />
                            {{-- <select class="form-control selectpicker" id="deatilKategori"
                                title="Choose one of the following..." required tabindex="null">
                                <option title="Enter your Kategori">-</option>
                            </select> --}}
                        </div>
                        <div class="col-lg-2">
                            <label>Currency:</label>
                            <input type="text" id="deatilCurrency" class="form-control"
                                placeholder="Enter your Kategori" readonly />
                            {{-- <select class="form-control selectpicker" id="deatilCurrency"
                                title="Enter your Currency" required tabindex="null">
                                <option title="Enter your Currency">-</option>
                            </select> --}}
                        </div>
...
// $('#table-so td a').on('click',function(){
//    e.preventDefault();
...
function Previous(id){
    $.ajax({
        url: `{{ url('showroom/po/previous/${id}') }}`,
        type: "GET",
        dataType: 'json',
        beforeSend: function() {
            swal.fire({
...
function Total(data){
    ...
    <tr>
        ...
        <td style="font-weight:bold">&nbsp;</td>
        <td style="font-weight:bold">`+harga_total+`,00</td>
        <td style="font-weight:bold">`+total_total+`,00</td>
    </tr>
    `
