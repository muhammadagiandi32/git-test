...
<head>
    <base href="../../">
    <title>BSW Malang - Showroom</title>
    <meta charset="utf-8" />
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed position-static"
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://keenthemes.com" target="_blank"
                                class="text-gray-800 text-hover-primary">BSW Malang</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
